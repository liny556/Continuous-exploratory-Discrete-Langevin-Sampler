...
plt.plot(x,cdmala,lw=2,label='cDMALA')
...
plt.xlim(left=0)
plt.savefig('figs/ising_learn/logrmse_.1.pdf')
plt.close()
...
dmalat = np.load('./figs/ising_learn/times_dmala_0.1_100.npy')
dulat = np.load('./figs/ising_learn/times_dula_0.25_100.npy')
cdmalat = np.load('./figs/ising_learn/times_cdmala_0.1_100.npy')
...
plt.plot(cdmalat,cdmala,lw=2,label='cDMALA')
...
plt.savefig('figs/ising_learn/time_logrmse_.1.pdf')
plt.close()